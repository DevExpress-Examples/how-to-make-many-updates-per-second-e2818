...
Namespace ManualDataUpdates
	Partial Public Class MainPage
		Inherits UserControl
		Private Const DataSourceRowCount As Integer = 10000
		Private RefreshDataIntervalInMilliseconds As New TimeSpan(0, 0, 0, 0, 1)
		Private Const UpdatedCellsCount As Integer = 10000

		Private list As New List(Of SampleData)()
		...
		Public Sub New()
			InitializeComponent()
			For i As Integer = 0 To DataSourceRowCount - 1
		...
		Private Sub timer_Tick(ByVal sender As Object, ByVal e As EventArgs)
			...
			If (Not refreshQueued) Then
				refreshQueued = True
				grid.Dispatcher.BeginInvoke(New Action(AddressOf RefreshData))
			End If
		End Sub
